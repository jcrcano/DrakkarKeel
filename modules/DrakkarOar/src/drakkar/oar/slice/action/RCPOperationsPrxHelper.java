...
public final class RCPOperationsPrxHelper extends Ice.ObjectPrxHelperBase implements RCPOperationsPrx
{
    public void
        ...
        throws drakkar.oar.slice.error.RequestException
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _RCPOperationsDel __del = (_RCPOperationsDel)__delBase;
    ...
    public static RCPOperationsPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        RCPOperationsPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (RCPOperationsPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::drakkar::oar::slice::action::RCPOperations"))
                {
                    RCPOperationsPrxHelper __h = new RCPOperationsPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::drakkar::oar::slice::action::RCPOperations", __ctx))
                {
                    RCPOperationsPrxHelper __h = new RCPOperationsPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::action::RCPOperations"))
                {
                    RCPOperationsPrxHelper __h = new RCPOperationsPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::action::RCPOperations", __ctx))
                {
                    RCPOperationsPrxHelper __h = new RCPOperationsPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _RCPOperationsDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _RCPOperationsDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, RCPOperationsPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            RCPOperationsPrxHelper result = new RCPOperationsPrxHelper();
