...
public final class ManagerPrxHelper extends Ice.ObjectPrxHelperBase implements ManagerPrx
{
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::drakkar::oar::slice::management::Manager"))
                {
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::drakkar::oar::slice::management::Manager", __ctx))
                {
                    ManagerPrxHelper __h = new ManagerPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::management::Manager"))
                {
                    ManagerPrxHelper __h = new ManagerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::management::Manager", __ctx))
                {
                    ManagerPrxHelper __h = new ManagerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
