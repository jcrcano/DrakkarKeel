...
public final class SessionContainerPrxHelper extends Ice.ObjectPrxHelperBase implements SessionContainerPrx
{
    public void
        ...
        throws drakkar.oar.slice.error.RequestException
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _SessionContainerDel __del = (_SessionContainerDel)__delBase;
    ...
    public static SessionContainerPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        SessionContainerPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (SessionContainerPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::drakkar::oar::slice::container::SessionContainer"))
                {
                    SessionContainerPrxHelper __h = new SessionContainerPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::drakkar::oar::slice::container::SessionContainer", __ctx))
                {
                    SessionContainerPrxHelper __h = new SessionContainerPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::container::SessionContainer"))
                {
                    SessionContainerPrxHelper __h = new SessionContainerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::container::SessionContainer", __ctx))
                {
                    SessionContainerPrxHelper __h = new SessionContainerPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _SessionContainerDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _SessionContainerDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, SessionContainerPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            SessionContainerPrxHelper result = new SessionContainerPrxHelper();
