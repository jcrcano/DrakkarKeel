 ...
 * servicios soportados por el framework DrakkarKeel en la aplicación servidora
 *
 * 
 *
 * @deprecated As of DrakkarKeel version 1.1,
 * replaced by <code>SternAppSetting</code>.
 *
 * @see drakkar.stern.SternAppSetting
 *
 */
public class SternData {
     ...
     *
     */
    public SternData(String adapterName, String serverName, String serverDescription, String containerName, String containerDescription, String sessionName, String sessionDescription, String fileStoreName) {
     ...
     * <br>
     */
    public SternData(String adapterName, int adapterPort, String serverName, String serverDescription, String containerName, String containerDescription) {
        this.adapterName = adapterName;
        this.serverName = serverName;
        this.serverDescription = serverDescription;
        this.containerName = containerName;
     ...
     * <br>
     */
    public SternData(String adapterName, int adapterPort, String serverName, String serverDescription, String containerName, String containerDescription, String sessionName, String sessionDescription) {
     ...
     * <br>
     */
    public SternData(String adapterName, int adapterPort, String serverName, String serverDescription, String containerName, String containerDescription, String fileStoreName) {
        this.adapterName = adapterName;
        this.serverName = serverName;
        this.serverDescription = serverDescription;
        this.adapterPort = (adapterPort >= 10000 && Utilities.isAvailablePort(adapterPort)) ? adapterPort : Utilities.getAvailablePort();
     ...
     * <br>
     */
    public SternData(String adapterName, int adapterPort, String serverName, String serverDescription, String containerName, String containerDescription, String sessionName, String sessionDescription, String fileStoreName) {
        this.adapterName = adapterName;
        this.serverName = serverName;
        this.serverDescription = serverDescription;
        this.adapterPort = (adapterPort >= 10000 && Utilities.isAvailablePort(adapterPort)) ? adapterPort : Utilities.getAvailablePort();
