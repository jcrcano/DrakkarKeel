 ...
 * replaced by <code>DelegateAuthentication</code>.
 *
 * @see drakkar.prow.communication.DelegateAuthentication
 *
 */
public class DlgAuthentication extends Delegate implements Serializable{
    private static final long serialVersionUID = 80000000000019L;
     ...
     */
    public DlgAuthentication(Communication comm, String name, String ip, int porNumber) {
     ...
     * @param authentPrx
     */
    public DlgAuthentication(Communication comm, String name, String ip, int porNumber, AuthenticationPrx authentPrx) {
        super(comm, name, ip, porNumber);
