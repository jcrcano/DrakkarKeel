...
/**
 * Esta clase constiye el evento mediante el cual se notificarán los diferentes
 * estados del servidor
 */
public class ServerEvent extends FacadeDesktopEvent {
     ...
     *                 del evento
     */
    public ServerEvent(Object source, Response response) {
