...
public class MetaResource implements IMetaResource {
     ...
     * @param metaDocument
     */
    public MetaResource(DocumentMetaData metaDocument) {
        super();
        this.id = metaDocument.getPath();
        this.metaDocument = metaDocument;
        this.score = metaDocument.getScore();
     ...
     * @param rank
     */
    public MetaResource(DocumentMetaData metaDocument, long rank) {
        super();
         this.id = metaDocument.getPath();
        this.metaDocument = metaDocument;
        this.score = metaDocument.getScore();
     ...
     * @param combinedValue
     */
    public MetaResource(DocumentMetaData metaDocument, long rank, double normalizedValue, double combinedValue) {
        super();
        this.id = metaDocument.getPath();
        this.metaDocument = metaDocument;
        this.score = metaDocument.getScore();
     ...
     */
    @Override
    public MetaResource clone() {
        try {
            return (MetaResource) super.clone();
