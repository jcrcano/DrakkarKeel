...
public class TermResource implements ITermResource {
    ...
    private TermSuggest term;

    /**
     *
     * @param term
     */
    public TermResource(TermSuggest term) {
        super();
        this.id = term.getTerm();
        this.term = term;
        this.score = term.getScore();
     ...
     * @param rank
     */
    public TermResource(TermSuggest term, long rank) {
        super();
         this.id = term.getTerm();
        this.term = term;
        this.score = term.getScore();
     ...
     * @param combinedValue
     */
    public TermResource(TermSuggest term, long rank, double normalizedValue, double combinedValue) {
        super();
        this.id = term.getTerm();
        this.term = term;
        this.score = term.getScore();
     ...
     */
    @Override
    public TermResource clone() {
        try {
            return (TermResource) super.clone();
