...
public final class ServerSidePrxHelper extends Ice.ObjectPrxHelperBase implements ServerSidePrx
{
    public void
        ...
        throws drakkar.oar.slice.error.RequestException
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ServerSideDel __del = (_ServerSideDel)__delBase;
    ...
    public static ServerSidePrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ServerSidePrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ServerSidePrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::drakkar::oar::slice::server::ServerSide"))
                {
                    ServerSidePrxHelper __h = new ServerSidePrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::drakkar::oar::slice::server::ServerSide", __ctx))
                {
                    ServerSidePrxHelper __h = new ServerSidePrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::server::ServerSide"))
                {
                    ServerSidePrxHelper __h = new ServerSidePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::drakkar::oar::slice::server::ServerSide", __ctx))
                {
                    ServerSidePrxHelper __h = new ServerSidePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _ServerSideDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ServerSideDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ServerSidePrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ServerSidePrxHelper result = new ServerSidePrxHelper();
