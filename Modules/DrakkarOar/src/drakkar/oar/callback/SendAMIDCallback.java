...
import drakkar.oar.slice.action.oneway.AMI_Send_sendAMID;
import drakkar.oar.util.OutputMonitor;

/**
 * Esta clase es utilizada para la invocación del método asíncrono sendAMID_async.
 * 
 * 
 */
public class SendAMIDCallback extends AMI_Send_sendAMID {

    /**
     * Constructor de la clase
     */
    public SendAMIDCallback() {
    }
